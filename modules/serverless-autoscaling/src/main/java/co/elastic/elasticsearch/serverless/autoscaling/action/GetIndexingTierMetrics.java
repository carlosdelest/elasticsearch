...
public class GetIndexingTierMetrics extends ActionType<TierMetricsResponse> {

    public static final GetIndexingTierMetrics INSTANCE = new GetIndexingTierMetrics();
