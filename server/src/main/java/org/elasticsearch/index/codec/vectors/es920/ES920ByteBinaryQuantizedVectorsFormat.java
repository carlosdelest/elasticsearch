...
public class ES920ByteBinaryQuantizedVectorsFormat extends FlatVectorsFormat {
    ...
    static final String META_CODEC_NAME = "ES920BinaryQuantizedVectorsFormatMeta";
    static final String VECTOR_DATA_CODEC_NAME = "ES920BinaryQuantizedVectorsFormatData";
    ...
    public String toString() {
        return "ES920BinaryQuantizedVectorsFormat(name=" + NAME + ", flatVectorScorer=" + scorer + ")";
    }
}
