...
public class RawStorageAccumulator implements DocumentSizeAccumulator {
    private static final Logger logger = LogManager.getLogger(RawStorageAccumulator.class);
    public static final String RA_STORAGE_KEY = RawStorageMetadataFieldMapper.FIELD_NAME;
