...
import co.elastic.elasticsearch.serverless.indexsize.IndexSizeService;
...
/**
 * Action used to collect shard metering info from all data node and reduce it to a single response for {@link IndexSizeService}.
 */
