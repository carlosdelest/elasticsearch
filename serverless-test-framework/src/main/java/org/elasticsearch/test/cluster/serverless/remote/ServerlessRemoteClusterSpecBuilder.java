...
public class ServerlessRemoteClusterSpecBuilder extends AbstractRemoteClusterSpecBuilder<ServerlessElasticsearchCluster> {
    ...
    public ServerlessElasticsearchCluster build() {
        return new ServerlessDevEnvironmentElasticsearchCluster(clusterAccessProviders);
    }
