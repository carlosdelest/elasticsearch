...
esplugin {
    name = "serverless-kibana"
    description = "Serverless kibana module for Elasticsearch"
    classname = "co.elastic.elasticsearch.serverless.kibana.ServerlessKibanaPlugin"
