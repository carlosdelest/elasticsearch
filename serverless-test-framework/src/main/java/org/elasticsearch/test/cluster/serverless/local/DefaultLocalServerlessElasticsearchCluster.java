...
public class DefaultLocalServerlessElasticsearchCluster extends DefaultLocalElasticsearchCluster<
    LocalClusterSpec,
    ServerlessLocalClusterHandle> implements ServerlessElasticsearchCluster {

    public DefaultLocalServerlessElasticsearchCluster(
        Supplier<LocalClusterSpec> specProvider,
        ServerlessLocalClusterFactory clusterFactory
    ) {
