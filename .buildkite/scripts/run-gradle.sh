...
GRADLEW="./gradlew --parallel --build-cache --no-watch-fs -Dorg.elasticsearch.build.cache.url=https://gradle-enterprise.elastic.co/cache/ -Dorg.elasticsearch.build.cache.push=true -Ddevelocity.deprecation.captureOrigin=true"
