...
package co.elastic.elasticsearch.serverless.operator;
...
/**
 * Custom rules for operator privileges when running in the serverless environment.
 */
public class ServerlessOperatorPlugin extends Plugin {
