    ...
    yamlRestTest {
        ...
        systemProperty(
            "tests.rest.blacklist", listOf(
                ...
                // The following 13_fields ones were added in https://github.com/elastic/elasticsearch/pull/94500 PR
                "indices.stats/13_fields/Fielddata fields - one global_ordinals",
                "indices.stats/13_fields/Fielddata fields - all metric global_ordinals",
                "indices.stats/13_fields/Fielddata fields - pattern global_ordinals",
                "indices.stats/13_fields/Fields - _all metric global_ordinals",
                "indices.stats/13_fields/Fields - pattern global_ordinals",
                "indices.stats/13_fields/Fielddata fields - one metric global_ordinals",
                "indices.stats/13_fields/Fields - multi metric global_ordinals",
                "indices.stats/13_fields/Fielddata fields - star global_ordinals",
                "indices.stats/13_fields/Fielddata fields - multi metric global_ordinals",
                "indices.stats/13_fields/Fields - fielddata metric global_ordinals",
                "indices.stats/13_fields/Fielddata fields - multi global_ordinals",
                "indices.stats/13_fields/Fields - star global_ordinals",
                "indices.stats/13_fields/Fields - multi global_ordinals",
                "indices.stats/13_fields/Fields - one global_ordinals",
