...
public class ServerlessSnapshotsPlugin extends Plugin implements ActionPlugin {
    public static final String NAME = "serverless-snapshots";
    ...
    public List<RestHandler> getRestHandlers(
        ...
        return List.of(new RestRestoreProjectAction());
    }
}
