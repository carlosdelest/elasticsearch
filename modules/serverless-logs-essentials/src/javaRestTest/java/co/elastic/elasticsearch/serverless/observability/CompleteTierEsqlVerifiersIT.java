...
public class CompleteTierEsqlVerifiersIT extends AbstractEsqlVerifiersIT {
    ...
    public static ServerlessElasticsearchCluster cluster = ServerlessElasticsearchCluster.local()
        ...
        .setting("serverless.observability.tier", ObservabilityTier.COMPLETE.name())
        .build();

    @Override
    protected ObservabilityTier getObservabilityTier() {
        return ObservabilityTier.COMPLETE;
    }
