...
package co.elastic.elasticsearch.serverless.enterprise.search.rest;
...
public class ServerlessEnterpriseSearchRestIT extends ESClientYamlSuiteTestCase {
    ...
    public ServerlessEnterpriseSearchRestIT(@Name("yaml") ClientYamlTestCandidate testCandidate) {
        super(testCandidate);
    }
