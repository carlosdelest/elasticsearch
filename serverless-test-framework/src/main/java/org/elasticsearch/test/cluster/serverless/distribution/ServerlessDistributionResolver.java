...
public class ServerlessDistributionResolver implements DistributionResolver {
    private final DistributionResolver delegate;

    public ServerlessDistributionResolver(DistributionResolver delegate) {
        this.delegate = delegate;
    }

    @Override
    public DistributionDescriptor resolve(Version version, DistributionType type) {
        return new ServerlessDistributionDescriptor(delegate.resolve(version, type));
    }
}
