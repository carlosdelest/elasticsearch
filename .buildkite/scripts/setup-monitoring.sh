...
ELASTIC_AGENT_URL=$(vault read -field=url secret/ci/elastic-elasticsearch-serverless/elastic-agent-token)
ELASTIC_AGENT_TOKEN=$(vault read -field=token secret/ci/elastic-elasticsearch-serverless/elastic-agent-token)
