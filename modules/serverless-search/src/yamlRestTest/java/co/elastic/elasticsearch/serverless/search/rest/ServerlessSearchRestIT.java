...
package co.elastic.elasticsearch.serverless.search.rest;
...
public class ServerlessSearchRestIT extends ESClientYamlSuiteTestCase {
    ...
    public ServerlessSearchRestIT(@Name("yaml") ClientYamlTestCandidate testCandidate) {
        super(testCandidate);
    }
